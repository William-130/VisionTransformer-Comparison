...
def load_training_history(model_name):
    ...
    Args:
        model_name (str): Nama model ('swin' atau 'vit')
...
def plot_learning_curves(models=["swin", "vit"]):
    """
...
def plot_confusion_matrices(models=["swin", "vit"], class_names=None):
    """
...
def plot_metrics_comparison(models=["swin", "vit"]):
    """
...
def plot_parameter_comparison(models=["swin", "vit"]):
    """
...
def plot_inference_time_comparison(models=["swin", "vit"]):
    """
...
def create_summary_figure(models=["swin", "vit"]):
    """
